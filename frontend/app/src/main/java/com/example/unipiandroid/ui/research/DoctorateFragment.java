...
import com.example.unipiandroid.databinding.FragmentDoctorateBinding;

public class DoctorateFragment extends Fragment {

    private FragmentDoctorateBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentDoctorateBinding.inflate(inflater, container, false);
