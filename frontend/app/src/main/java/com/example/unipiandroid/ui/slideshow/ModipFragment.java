...
import com.example.unipiandroid.databinding.FragmentModipBinding;

public class ModipFragment extends Fragment {
    private FragmentModipBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentModipBinding.inflate(inflater, container, false);
