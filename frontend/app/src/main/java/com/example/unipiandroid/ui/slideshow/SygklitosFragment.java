...
import com.example.unipiandroid.databinding.FragmentSugklitosBinding;

public class SygklitosFragment extends Fragment {
    private FragmentSugklitosBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentSugklitosBinding.inflate(inflater, container, false);
