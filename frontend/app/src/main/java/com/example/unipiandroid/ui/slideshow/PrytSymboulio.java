...
import com.example.unipiandroid.databinding.FragmentPrytsymboulioBinding;

public class PrytSymboulio extends Fragment {
    private FragmentPrytsymboulioBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentPrytsymboulioBinding.inflate(inflater, container, false);
