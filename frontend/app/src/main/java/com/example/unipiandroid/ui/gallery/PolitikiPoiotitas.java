...
import com.example.unipiandroid.databinding.FragmentLocationBinding;
...
import com.example.unipiandroid.MainActivity;
import com.example.unipiandroid.R;
import com.example.unipiandroid.databinding.FragmentPoiotitasBinding;

public class PolitikiPoiotitas extends Fragment {
    private FragmentPoiotitasBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentPoiotitasBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        TextView text = (TextView) root.findViewById(R.id.textView39);
