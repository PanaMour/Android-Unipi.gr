package com.example.unipiandroid.ui.slideshow;
...
import com.example.unipiandroid.databinding.FragmentDioikitikesypBinding;

public class DioikitikesYpuresies extends Fragment {

    private FragmentDioikitikesypBinding binding;
    private SharedPreferences sharedPreferences;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentDioikitikesypBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        TextView text = (TextView) root.findViewById(R.id.textView59);
