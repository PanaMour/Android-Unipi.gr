package com.example.unipiandroid.ui.gallery;
...
import com.example.unipiandroid.MainActivity;
import com.example.unipiandroid.R;
import com.example.unipiandroid.databinding.FragmentProstasiadedBinding;


public class ProstasiaDedomenon extends Fragment{
    private FragmentProstasiadedBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentProstasiadedBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        TextView text1 = (TextView) root.findViewById(R.id.textView28);
        TextView text2 = (TextView) root.findViewById(R.id.textView37);
        TextView text3 = (TextView) root.findViewById(R.id.textView38);
