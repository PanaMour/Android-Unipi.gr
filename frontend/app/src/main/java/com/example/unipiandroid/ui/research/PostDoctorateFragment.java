package com.example.unipiandroid.ui.research;
...
import com.example.unipiandroid.databinding.FragmentPostdoctorateBinding;

public class PostDoctorateFragment extends Fragment {

    private FragmentPostdoctorateBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentPostdoctorateBinding.inflate(inflater, container, false);
