...
import com.example.unipiandroid.MainActivity;
import com.example.unipiandroid.R;
import com.example.unipiandroid.databinding.FragmentPrytanikiarxiBinding;

public class PrytanikiArxi extends Fragment {
    private FragmentPrytanikiarxiBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentPrytanikiarxiBinding.inflate(inflater, container, false);
