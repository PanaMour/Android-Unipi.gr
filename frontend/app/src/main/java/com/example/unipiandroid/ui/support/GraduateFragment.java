...
import com.example.unipiandroid.databinding.FragmentGraduateBinding;

public class GraduateFragment extends Fragment {
    private FragmentGraduateBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        binding = FragmentGraduateBinding.inflate(inflater, container, false);
